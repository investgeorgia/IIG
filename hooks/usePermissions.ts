...
export function usePermissions() {
  ...
  const hasPermission = (moduleName: string, requiredLevel: AccessLevel): boolean => {
    ...
    if (moduleName === 'Users' || moduleName === 'Settings' || moduleName === 'Pages' || moduleName === 'Salespersons' || moduleName === 'Analytics' || moduleName === 'Templates' || moduleName === 'ProjectPortfolio') {
